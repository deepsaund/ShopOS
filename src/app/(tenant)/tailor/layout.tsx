...
const navItems = [
  ...
  { name: "Customers", href: "/tailor/customers", icon: Users },
  { name: "Orders", href: "/tailor/orders", icon: Scissors },
  { name: "Fabric Stock", href: "/tailor/stock", icon: Layers },
];
    ...
    <div className="flex h-screen bg-gray-50/50 overflow-hidden font-sans text-gray-800">
      ...
      <aside className="hidden md:flex flex-col w-64 border-r border-gray-200/60 bg-white">
        <div className="flex h-16 items-center px-6 border-b border-gray-100 gap-2.5">
          ...
          <span className="font-bold text-xl text-gray-900 tracking-tight">ShopOS CRM</span>
        </div>
          ...
          <aside className="relative flex flex-col w-64 bg-white h-full border-r border-gray-100 animate-slide-in">
            <div className="flex h-16 items-center justify-between px-6 border-b border-gray-100">
              <div className="flex items-center gap-2">
                <Store className="h-6 w-6 text-violet-600" />
                <span className="font-bold text-lg text-gray-900">ShopOS CRM</span>
              </div>
        ...
        <header className="h-16 flex items-center justify-between px-6 bg-white border-b border-gray-200/60 flex-shrink-0">
          <div className="flex items-center gap-4">
            ...
            <h1 className="font-semibold text-lg text-gray-900 hidden sm:block">
              {pathname.includes("/dashboard") && "CRM Dashboard"}
              {pathname.includes("/customers") && !pathname.includes("/orders") && "Customer Profiles"}
              {pathname.includes("/orders") && "Order Management"}
              {pathname.includes("/stock") && "Fabric Inventory"}
            </h1>
          </div>
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              >
                ...
                <option value="custom-tailor-shop">Custom Shop Tenant</option>
              </select>
            </div>
          </div>
        </header>
